          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <a href="https://github.com/dropfundapp" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-gray-200 rounded-lg flex items-center justify-center hover:bg-blue-50 hover:border-blue-500 transition-all">
                  <svg className="w-5 h-5 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
